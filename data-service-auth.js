...
function check(str){ //Function which checks for whitespace or empty space
    return str === null || str.match(/^ *$/) !== null;
}

exports.initialize = function(){
    return new Promise(function(resolve, reject){
        let db = mongoose.createConnection(`mongodb+srv://test4:123@test4.wpdlxy0.mongodb.net/a6?retryWrites=true&w=majority`);
